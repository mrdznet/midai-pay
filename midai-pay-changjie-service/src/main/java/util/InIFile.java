...
public class InIFile {
	private static Logger LOG = Logger.getLogger(InIFile.class);
	...
	private void init(InputStream ins) throws Exception {
		...
		while ((line = in.readLine()) != null) {
			...
			pmap.put(key, value);
			if("MERCHANT_ID,BUSINESS_CODE,CORP_ACCT_NO,PRODUCT_CODE,CJ_GATEWAY_URL,YS_PFX_PATH,CJ_CERT_PATH,CORP_ACCT_NAME".contains(key)){
