...
public class Cj {
	...
	public static final String CJPARAM_corpAcctNo;
	public static final String CJPARAM_corpAcctName;
	public static final String CJPARAM_productCode;
	...
	static {
		...
		CJPARAM_corpAcctNo = g.get("CORP_ACCT_NO");
		CJPARAM_corpAcctName = g.get("CORP_ACCT_NAME");
		CJPARAM_productCode= g.get("PRODUCT_CODE");
	...
	public static final String XMLMSG_TRANS_CODE_银行余额查询 = "G20015";
