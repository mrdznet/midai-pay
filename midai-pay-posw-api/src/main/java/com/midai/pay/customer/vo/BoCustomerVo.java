...
@Data
@ApiModel
public class BoCustomerVo implements Serializable{
		...
		@ApiModelProperty(value="商户类型 0:普通商户  1:自动到账商户")
		private Integer merAuto;
		
		private String merAutoStr;
	    ...
	    @ApiModelProperty(value="商户公司编号")
	    private String inscode;
	    
	    @ApiModelProperty(value="首次业务时间")
	    private String firstTradeTime;
	    
	    @ApiModelProperty(value="编辑权限(0-否, 1-能)")
