...
public class SecurityUtil {
	...
	public static void main(String[] args) throws Exception {
		// System.out.println(desEncrypt("6222021001113527219",
		// "card.encrypt.baofoo.com"));
		// System.out.println(desDecrypt("2a69589767bb68cc1fe7e5e7ba03ea59b4988e3dcb9c126f",
		// "fi_gw_express_order.card_no"));
		System.out.println(desEncrypt("6228480031572810914", "card.encrypt.baofoo.com"));
